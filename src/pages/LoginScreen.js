      ...
      <div className="min-h-screen bg-gray-200 flex items-center justify-center p-4 font-sans">
        <div className="relative w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2">
          ...
          <div className="p-8 md:p-12 bg-gradient-to-br from-white to-purple-50/50">
            ...
            <form className="mt-12 space-y-5" onSubmit={handleLoginSubmit}>
              <div>
                ...
                <input className="w-full mt-1 p-3 border border-gray-300 rounded-lg bg-white/50 focus:outline-none focus:ring-2 focus:ring-indigo-500" id="email" type="email" placeholder="Enter your email address" defaultValue="demo@workflow.com"/>
              </div>
              <div>
                <label className="text-sm font-semibold text-gray-700" htmlFor="password">Password</label>
                <input className="w-full mt-1 p-3 border border-gray-300 rounded-lg bg-white/50 focus:outline-none focus:ring-2 focus:ring-indigo-500" id="password" type="password" placeholder="Password" defaultValue="••••••••"/>
              </div>
              <div>
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center text-gray-600 cursor-pointer"><input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" /><span className="ml-2">Remember me</span></label>
                <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Forgot password?</a>
              </div>
              <div className="pt-4">
                <button type="submit" className="w-full bg-indigo-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-indigo-700 transition">Login</button>
              </div>
            </form>
          </div>
          ...
          <div className="p-8 md:p-12 flex flex-col items-center justify-center text-center">
              ...
              <button onClick={() => navigate('/signup')} className="w-full max-w-xs mt-2 flex items-center justify-center gap-2 bg-indigo-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-indigo-700 transition">
                <FiMail />
                Sign Up with Email
              </button>
